...
export function Apply() {
  return (
    <div className="container mb-32">
      <div className="mb-12">
        <a id="apply">
          <h2 className="mb-4 text-4xl">Membership Requirements</h2>
        </a>
        <p className="text-[#707070]">
          We require that all students have a passion for Computer Science and
          ...
          <div className="md:basis-1/2">
            ...
            >
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="text-[#707070]">
                  You must be logged in with your school google email to be able
                  to access the form.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
